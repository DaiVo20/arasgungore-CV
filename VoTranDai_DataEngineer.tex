...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeEducationHeading
      ...
      {B.Sc. in Data Science;   \textbf{GPA: 8.51/10 Good}}{Sep 2019 \textbf{--} Jun 2023}
...
\section{Certificates}
  \resumeSubHeadingListStart
    ...
    \resumeOrganizationHeading
      {Machine Learning Specialization}{Feb 2022}
      % {Business Skills, Data and Digital Skills, Project Management and Personal Productivity}
    
    \resumeOrganizationHeading
      {IBM Data Science Specialization}{Aug 2022}
      % {Business Skills, Data and Digital Skills, Project Management and Personal Productivity}
...
\section{Projects}
    ...
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
        {\textbf{Vehicle Speed Estimation on the Vietnam’s Street Real-time} }
        % $|$ 
        ...
        {Video from data sources are pushed into model by Kafka. The vehicles are detected and tracked to estimate speed real-time.}
          \resumeItemListStart
            ...
            % model popular fractals including Mandelbrot set, Julia set, 
            % Koch curve, Barnsley fern, and Sierpinski triangle in PPM format.}
            \resumeItem{\textbf{Skills:} Python, Kafka, OpenCV, Flask, 
            Models (Yolov7, DeepSORT).}
          \resumeItemListEnd
